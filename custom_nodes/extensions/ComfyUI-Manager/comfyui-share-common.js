...
export const shareToEsheep = () => {
  app.graphToPrompt().then((prompt) => {
    ...
    api
      .fetchApi(`/manager/set_esheep_workflow_and_images`, {
        method: 'POST',
      ...
      .then((response) => {
        ...
        window.open(
          'https://www.esheep.com/app/workflow_upload?from_local=' + full_domin,
          '_blank'
        )
      })
  })
...
export const showCopusShareDialog = () => {
  ...
  return app
    ...
    .then((nodes) => {
      const { potential_outputs, potential_output_nodes } =
        getPotentialOutputsAndOutputNodes(nodes)
      CopusShareDialog.instance.show({
        potential_outputs,
  ...
  createButtons() {
    const buttons = [
      ...
      },
      {
        ...
        description:
          'Share your workflow or transform it into an interactive app on YouML.com',
        onclick: () => {
      ...
      },
      {
        ...
        description:
          "Share & browse thousands of ComfyUI workflows and art 🎨<br/><br/><a style='color:var(--input-text);' href='https://comfyworkflows.com' target='_blank'>ComfyWorkflows.com</a>",
        onclick: () => {
      ...
      },
      {
        ...
        description:
          "Share & download thousands of ComfyUI workflows on <a style='color:var(--input-text);' href='https://www.esheep.com' target='_blank'>esheep.com</a>",
        onclick: () => {
          shareToEsheep()
          this.close()
        }
      },
      {
        ...
        description:
          '🔴 Earn simple. Get paid from your ComfyUI workflows—no revenue sharing. Ever.',
        onclick: () => {
      ...
      buttons.forEach((b) => {
        ...
        const copus_ui = $el('div', {
          style: {
            ...
            'z-index': '-1',
            background:
              'url("https://static.copus.io/images/client/202412/test/f28ac6ef8f4c6f3d5d50856a272ed02c.png")',
            'background-repeat': 'no-repeat'
          }
        })
        const copus_ui_bottom = $el('div', {
          style: {
            position: 'absolute',
            height: '100%',
            left: '25px',
        ...
        const column = $el(
          ...
          [
            buttonLinkContainer,
            description,
            b.key === 'Copus' ? copus_ui : '',
            b.key === 'Copus' ? copus_ui_bottom : ''
          ]
        )
  ...
  createButtons() {
          ...
          $el(
            ...
            [
              ...
              $el('p', { size: 3, color: 'white' }, [
                'If provided, your art will be saved to your account. Otherwise, it will be shared anonymously.'
              ]),
    ...
    this.share_button.onclick = async () => {
      ...
      if (
        ...
        //!confirm("You have NOT set your ComfyWorkflows.com share key. Your art will NOT be connected to your account (it will be shared anonymously). Continue?")) {
        return
      }
