...
function showPreviewCanvas(node, app) {
  const widget = {
    ...
    draw: function (ctx, node, widgetWidth, widgetY) {
      ...
      ctx.fillRect(widgetX, widgetYBar, backgroundWidth, barHeight)
      ...
      ctx.fillRect(widgetX, widgetYBar, backgroundWidth * progress, barHeight)
    }
  }
