...
class DynamicContextSwitchNode extends DynamicContextNodeBase {
  ...
  refreshInputsAndOutputs() {
    ...
    for (let i = 0; i < this.inputs.length; i++) {
      ...
      for (const slotData of slotsData) {
        const found = inputs.find(
          (n) =>
            getContextOutputName(slotData.name) === getContextOutputName(n.name)
        )
        if (found) {
          found.count += 1
          continue
    ...
    while (this.outputs[i]) {
      ...
      if (
        (_a = output === null || output === void 0 ? void 0 : output.links) ===
          null || _a === void 0
          ? void 0
          : _a.length
      ) {
  ...
  onDrawForeground(ctx, canvas) {
    ...
    const low_quality =
      ((_b =
        (_a = canvas === null || canvas === void 0 ? void 0 : canvas.ds) ===
          null || _a === void 0
          ? void 0
          : _a.scale) !== null && _b !== void 0
        ? _b
        : 1) < 0.6
