...
app.registerExtension({
  ...
  async beforeRegisterNodeDef(nodeType, nodeData) {
      ...
      let handled =
        (_a =
          onDragOver === null || onDragOver === void 0
            ? void 0
            : onDragOver.apply) === null || _a === void 0
          ? void 0
          : _a.call(onDragOver, this, [...arguments])
      if (handled != null) {
        return handled
      }
    ...
    nodeType.prototype.onDragDrop = async function (e) {
      var _a
      const alreadyHandled = await ((_a =
        onDragDrop === null || onDragDrop === void 0
          ? void 0
          : onDragDrop.apply) === null || _a === void 0
        ? void 0
        : _a.call(onDragDrop, this, [...arguments]))
      if (alreadyHandled) {
...
export function importIndividualNodesInnerOnDragOver(node, e) {
  var _a
  return (
    (((_a = node.widgets) === null || _a === void 0 ? void 0 : _a.length) &&
...
export async function importIndividualNodesInnerOnDragDrop(node, e) {
  ...
  if (!handled && workflow) {
    ...
    if (
      ((_b =
        exact === null || exact === void 0 ? void 0 : exact.widgets_values) ===
        null || _b === void 0
        ? void 0
        : _b.length) &&
      confirm(
      ...
      node.configure({
        title: node.title,
        widgets_values: [
          ...((exact === null || exact === void 0
            ? void 0
            : exact.widgets_values) || [])
        ]
      })
      handled = true
    }
