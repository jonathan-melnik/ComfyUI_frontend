...
export async function showLoraChooser(event, callback, parentMenu, loras) {
  ...
  new LiteGraph.ContextMenu(loras, {
    ...
    scale: Math.max(
      1,
      (_b = (_a = canvas.ds) === null || _a === void 0 ? void 0 : _a.scale) !==
        null && _b !== void 0
        ? _b
        : 1
    ),
...
export function showNodesChooser(event, mapFn, callback, parentMenu) {
  var _a, _b
  const canvas = app.canvas
  const nodesOptions = app.graph._nodes.map(mapFn).filter((e) => e != null)
...
export function showWidgetsChooser(event, node, mapFn, callback, parentMenu) {
  var _a, _b
  const options = (node.widgets || []).map(mapFn).filter((e) => e != null)
  if (options.length) {
    const canvas = app.canvas
    new LiteGraph.ContextMenu(options, {
      ...
      scale: Math.max(
        1,
        (_b =
          (_a = canvas.ds) === null || _a === void 0 ? void 0 : _a.scale) !==
          null && _b !== void 0
          ? _b
          : 1
      ),
