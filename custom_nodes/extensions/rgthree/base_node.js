...
export class RgthreeBaseNode extends LGraphNode {
  ...
  defaultGetSlotMenuOptions(slot) {
    ...
    if (
      (_b =
        (_a = slot === null || slot === void 0 ? void 0 : slot.output) ===
          null || _a === void 0
          ? void 0
  ...
  getExtraMenuOptions(canvas, options) {
    ...
    if (super.getExtraMenuOptions) {
      ...
      (_c =
        (_b = this.constructor.nodeType) === null || _b === void 0
          ? void 0
          : _b.prototype) === null || _c === void 0
        ? void 0
        : _c.getExtraMenuOptions
    ) {
      ;(_f =
        (_e =
          (_d = this.constructor.nodeType) === null || _d === void 0
            ? void 0
            : _d.prototype) === null || _e === void 0
          ? void 0
...
export class RgthreeBaseServerNode extends RgthreeBaseNode {
  ...
  async setupFromServerNodeData() {
    ...
    for (const inputName in inputs) {
      ...
      if (
        (_a = inputData[1]) === null || _a === void 0 ? void 0 : _a.forceInput
      ) {
  ...
  static registerForOverride(comfyClass, nodeData, rgthreeClass) {
    if (OVERRIDDEN_SERVER_NODES.has(comfyClass)) {
      throw Error(
        `Already have a class to override ${comfyClass.type || comfyClass.name || comfyClass.title}`
      )
    }
