  ...
  refreshWidgets() {
    ...
    let sort =
      ((_a = this.properties) === null || _a === void 0
        ? void 0
        : _a[PROPERTY_SORT]) || 'position'
    let customAlphabet = null
    if (sort === 'custom alphabet') {
      const customAlphaStr =
        (_c =
          (_b = this.properties) === null || _b === void 0
            ? void 0
            : _b[PROPERTY_SORT_CUSTOM_ALPHA]) === null || _c === void 0
          ? void 0
          : _c.replace(/\n/g, '')
      ...
      if (
        !(customAlphabet === null || customAlphabet === void 0
          ? void 0
          : customAlphabet.length)
      ) {
        sort = 'alphanumeric'
        customAlphabet = null
      }
    ...
    if (
      ...
      groups.sort((a, b) => {
        ...
        for (const [index, alpha] of customAlphabet.entries()) {
          aIndex =
            aIndex < 0
              ? a.title.toLocaleLowerCase().startsWith(alpha)
                ? index
                : -1
              : aIndex
          bIndex =
            bIndex < 0
              ? b.title.toLocaleLowerCase().startsWith(alpha)
                ? index
                : -1
              : bIndex
    ...
    let filterColors = (
      ((_e =
        (_d = this.properties) === null || _d === void 0
          ? void 0
          : _d[PROPERTY_MATCH_COLORS]) === null || _e === void 0
        ? void 0
        : _e.split(',')) || []
    ).filter((c) => c.trim())
    ...
    for (const group of groups) {
      if (filterColors.length) {
        let groupColor =
          (_f = group.color) === null || _f === void 0
            ? void 0
            : _f.replace('#', '').trim().toLocaleLowerCase()
        if (!groupColor) {
          continue
        }
      ...
      if (
        (_h =
          (_g = this.properties) === null || _g === void 0
            ? void 0
            : _g[PROPERTY_MATCH_TITLE]) === null || _h === void 0
          ? void 0
          : _h.trim()
      ) {
        try {
          if (
            !new RegExp(this.properties[PROPERTY_MATCH_TITLE], 'i').exec(
              group.title
            )
          ) {
            continue
      ...
      if (!widget) {
        ...
        widget = this.addCustomWidget({
          ...
          draw: function (ctx, node, width, posY, height) {
            ...
            const showNav =
              ((_a = node.properties) === null || _a === void 0
                ? void 0
                : _a[PROPERTY_SHOW_NAV]) !== false
          ...
          mouse(event, pos, node) {
            ...
            if (event.type == 'pointerdown') {
              if (
                ...
                const canvas = app.canvas
                const lowQuality =
                  (((_b = canvas.ds) === null || _b === void 0
                    ? void 0
                    : _b.scale) || 1) <= 0.5
                if (!lowQuality) {
                  canvas.centerOnNode(group)
                  const zoomCurrent =
                    ((_c = canvas.ds) === null || _c === void 0
                      ? void 0
                      : _c.scale) || 1
                ...
                setTimeout(() => {
                  ...
                  ;(_a = this.callback) === null || _a === void 0
                    ? void 0
                    : _a.call(this, this.value, app.canvas, node, pos, event)
                }, 20)
              }
            }
            return true
        ...
        widget.doModeChange = (force, skipOtherNodeCheck) => {
          ...
          const hasAnyActiveNodes = group._nodes.some(
          ...
          if (skipOtherNodeCheck !== true) {
            if (
              ...
              ((_b =
                (_a = this.properties) === null || _a === void 0
                  ? void 0
                  : _a[PROPERTY_RESTRICTION]) === null || _b === void 0
                ? void 0
                : _b.includes(' one'))
            ) {
              ...
              !newValue &&
              ((_c = this.properties) === null || _c === void 0
                ? void 0
                : _c[PROPERTY_RESTRICTION]) === 'always one'
            ) {
  ...
  async handleAction(action) {
    ...
    if (action === 'Mute all' || action === 'Bypass all') {
      const alwaysOne =
        ((_a = this.properties) === null || _a === void 0
          ? void 0
          : _a[PROPERTY_RESTRICTION]) === 'always one'
      ...
      const onlyOne =
        (_b = this.properties) === null || _b === void 0
          ? void 0
          : _b[PROPERTY_RESTRICTION].includes(' one')
      for (const [index, widget] of this.widgets.entries()) {
        widget === null || widget === void 0
          ? void 0
      ...
      const onlyOne =
        (_c = this.properties) === null || _c === void 0
          ? void 0
          : _c[PROPERTY_RESTRICTION].includes(' one')
      let foundOne = false
      for (const [index, widget] of this.widgets.entries()) {
      ...
      if (
        ...
        ((_d = this.properties) === null || _d === void 0
          ? void 0
          : _d[PROPERTY_RESTRICTION]) === 'always one'
      ) {
        ;(_e = this.widgets[this.widgets.length - 1]) === null || _e === void 0
          ? void 0
          : _e.doModeChange(true, true)
      }
    }
  }
  getHelp() {
...
BaseFastGroupsModeChanger.exposedActions = [
  'Mute all',
  'Enable all',
  'Toggle all'
]
