...
class FastActionsButton extends BaseAnyInputConnectedNode {
  ...
  handleLinkedNodesStabilization(linkedNodes) {
    ...
    for (const [widget, data] of this.widgetToData.entries()) {
      ...
      if (!linkedNodes.includes(data.node)) {
        ...
        if (index > -1) {
          ...
          const [m, a] = this.logger.debugParts(
            'Connected widget is not in widgets... weird.'
          )
    ...
    for (const [index, node] of linkedNodes.entries()) {
      if (!node) {
        const [m, a] = this.logger.debugParts(
          'linkedNode provided that does not exist. '
        )
        ;(_b = console[m]) === null || _b === void 0
          ? void 0
          : _b.call(console, ...a)
        badNodes.push(node)
        continue
      ...
      if (
        widgetAtSlot &&
        ((_c = this.widgetToData.get(widgetAtSlot)) === null || _c === void 0
          ? void 0
          : _c.comfy)
      ) {
        indexOffset++
      ...
      if (
        !widgetAtSlot ||
        ((_e =
          (_d = this.widgetToData.get(widgetAtSlot)) === null || _d === void 0
            ? void 0
        ...
        for (let i = index + indexOffset; i < this.widgets.length; i++) {
          if (
            ((_g =
              (_f = this.widgetToData.get(this.widgets[i])) === null ||
              _f === void 0
                ? void 0
    ...
    for (
      ...
      if (
        widgetAtSlot &&
        ((_h = this.widgetToData.get(widgetAtSlot)) === null || _h === void 0
          ? void 0
          : _h.comfy)
      ) {
        continue
  ...
  async executeConnectedNodes() {
    ...
    for (const widget of this.widgets) {
      ...
      const { comfy, node } =
        (_a = this.widgetToData.get(widget)) !== null && _a !== void 0 ? _a : {}
      if (comfy) {
