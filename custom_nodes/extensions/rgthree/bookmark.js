...
export class Bookmark extends RgthreeBaseVirtualNode {
  ...
  get shortcutKey() {
    ...
    return (_c =
      (_b =
        (_a = this.widgets[0]) === null || _a === void 0
          ? void 0
          : _a.value) === null || _b === void 0
        ? void 0
        : _b.toLocaleLowerCase()) !== null && _c !== void 0
      ? _c
      : ''
  }
  onAdded(graph) {
  ...
  onMouseDown(event, pos, graphCanvas) {
    ...
    if (
      input &&
      input.value ===
        ((_a = this.widgets[0]) === null || _a === void 0 ? void 0 : _a.value)
    ) {
...
function getNextShortcut() {
  ...
  return (_a = SHORTCUT_DEFAULTS.find(
    (char) => !existingShortcuts.has(char)
  )) !== null && _a !== void 0
    ? _a
    : '1'
}
