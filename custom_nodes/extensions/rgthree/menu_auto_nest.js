...
app.registerExtension({
  ...
  async setup() {
    ...
    LiteGraph.ContextMenu = function (values, options) {
      ...
      const threshold = CONFIG_SERVICE.getConfigValue(
        'features.menu_auto_nest.threshold',
        20
      )
      const enabled = CONFIG_SERVICE.getConfigValue(
        'features.menu_auto_nest.subdirs',
        false
      )
      let incompatible =
        !enabled ||
        !!((_a =
          ...
          null || _a === void 0
          ? void 0
          : _a.rgthree_doNotNest)
      if (!incompatible) {
        if (values.length <= threshold) {
          incompatible = `Skipping context menu auto nesting b/c threshold is not met (${threshold})`
        }
        if (
          !((_b = options.parentMenu) === null || _b === void 0
            ? void 0
            : _b.options.rgthree_originalCallback)
        ) {
          if (
      ...
      if (foldersCount > 0) {
        ...
        const [n, v] = logger.infoParts(
          `Nested folders found (${foldersCount}).`
        )
        ;(_e = console[n]) === null || _e === void 0
          ? void 0
          : _e.call(console, ...v)
        const newValues = []
      ...
      if (options.scale == null) {
        options.scale = Math.max(
          ((_f = app.canvas.ds) === null || _f === void 0
            ? void 0
            : _f.scale) || 1,
          1
        )
      ...
      if (
        oldCtrResponse === null || oldCtrResponse === void 0
          ? void 0
          : oldCtrResponse.constructor
      ) {
