...
const RGX_ATTRS_MAYBE_OPEN = new RegExp(
  `\\[${RGX_STRING_CONTENT_TO_SQUARES}`,
  'gi'
)
const RGX_ATTRS_FOLLOW_OPEN = new RegExp(
  `^${RGX_STRING_CONTENT_TO_SQUARES}`,
  'gi'
)
...
export function queryOne(selectors, parent = document) {
  var _a
  return (_a = parent.querySelector(selectors)) !== null && _a !== void 0
    ? _a
    : null
}
...
export function containsOrSelf(parent, contained) {
  ...
  return (
    parent === contained ||
    ((_a = parent === null || parent === void 0 ? void 0 : parent.contains) ===
      null || _a === void 0
      ? void 0
      : _a.call(parent, contained)) ||
    false
  )
}
export function createElement(selectorOrMarkup, attrs) {
  ...
  let element =
    frag === null || frag === void 0 ? void 0 : frag.firstElementChild
  let selector = ''
  if (!element) {
...
function getSelectorAttributes(selector) {
  ...
  while ((result = RGX_ATTRS_MAYBE_OPEN.exec(selector))) {
    ...
    if (attr.endsWith(']')) {
      ...
      attr =
        result[0] +
        getOpenAttributesRecursive(
          selector.substr(RGX_ATTRS_MAYBE_OPEN.lastIndex),
          2
        )
...
function getOpenAttributesRecursive(selectorSubstring, openCount) {
  ...
  if (matches && matches.length) {
    ...
    if (openCount > 0) {
      result += getOpenAttributesRecursive(
        selectorSubstring.substr(result.length),
        openCount
      )
    }
  }
...
function tryMatch(str, rgx, index = 1) {
  ...
  try {
    found =
      ((_a = str.match(rgx)) === null || _a === void 0 ? void 0 : _a[index]) ||
      ''
  } catch (e) {
    found = ''
  }
...
export function setAttribute(element, attribute, value) {
  ...
  if (attribute === 'text') {
    ...
    if (typeof value === 'string') {
      element.style.cssText = isRemoving
        ? ''
        : value != null
          ? String(value)
          : ''
    ...
    ['checked', 'disabled', 'readonly', 'required', 'selected'].includes(
      attribute
    )
  ) {
