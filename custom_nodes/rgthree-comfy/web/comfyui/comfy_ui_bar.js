...
function addRgthreeTopBarButtons() {
  ...
  if (!CONFIG_SERVICE.getFeatureValue('comfy_top_bar_menu.enabled')) {
    if (
      (_a =
        rgthreeButtonGroup === null || rgthreeButtonGroup === void 0
          ? void 0
          : rgthreeButtonGroup.element) === null || _a === void 0
        ? void 0
        : _a.parentElement
    ) {
      rgthreeButtonGroup.element.parentElement.removeChild(
        rgthreeButtonGroup.element
      )
    }
    return
  } else if (rgthreeButtonGroup) {
    ;(_b = app.menu) === null || _b === void 0
      ? void 0
      : _b.settingsGroup.element.before(rgthreeButtonGroup.element)
    return
  }
  const buttons = []
  ...
  if (
    CONFIG_SERVICE.getFeatureValue(
      'comfy_top_bar_menu.button_bookmarks.enabled'
    )
  ) {
    ...
    bookmarksListEl.appendChild(
      createElement('li.rgthree-message', {
        child: createElement('span', {
          text: 'No bookmarks in current workflow.'
        })
      })
    )
  ...
  ;(_c = app.menu) === null || _c === void 0
    ? void 0
    : _c.settingsGroup.element.before(rgthreeButtonGroup.element)
}
    ...
    CONFIG_SERVICE.addEventListener('config-change', (e) => {
      ...
      if (
        (_b = (_a = e.detail) === null || _a === void 0 ? void 0 : _a.key) ===
          null || _b === void 0
          ? void 0
          : _b.includes('features.comfy_top_bar_menu')
      ) {
        addRgthreeTopBarButtons()
      }
    })
