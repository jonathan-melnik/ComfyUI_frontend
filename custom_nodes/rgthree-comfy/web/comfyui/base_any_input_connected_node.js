...
export class BaseAnyInputConnectedNode extends RgthreeBaseVirtualNode {
  ...
  stabilizeInputsOutputs() {
    var _a
    let changed = false
    const hasEmptyInput = !((_a = this.inputs[this.inputs.length - 1]) ===
      null || _a === void 0
      ? void 0
      : _a.link)
    if (!hasEmptyInput) {
    ...
    for (let index = this.inputs.length - 2; index >= 0; index--) {
      ...
      if (!input.link) {
        ...
        const newName =
          (node === null || node === void 0 ? void 0 : node.title) || ''
  ...
  computeSize(out) {
    ...
    if (this.properties['collapse_connections']) {
      const rows =
        Math.max(
          ((_a = this.inputs) === null || _a === void 0 ? void 0 : _a.length) ||
            0,
          ((_b = this.outputs) === null || _b === void 0
            ? void 0
            : _b.length) || 0,
          1
        ) - 1
  ...
  connectByTypeOutput(slot, sourceNode, sourceSlotType, optsIn) {
    ...
    if (
      !(lastInput === null || lastInput === void 0 ? void 0 : lastInput.link) &&
      (lastInput === null || lastInput === void 0 ? void 0 : lastInput.type) ===
        '*'
    ) {
      var sourceSlot = sourceNode.findOutputSlotByType(
        sourceSlotType,
        false,
        true
      )
  ...
  static setUp() {
    ...
    addMenuItem(this, app, {
      name: (node) => {
        var _a
        return `${((_a = node.properties) === null || _a === void 0 ? void 0 : _a['collapse_connections']) ? 'Show' : 'Collapse'} Connections`
      },
      property: 'collapse_connections',
      prepareValue: (_value, node) => {
        var _a
        return !((_a = node.properties) === null || _a === void 0
          ? void 0
          : _a['collapse_connections'])
      },
      callback: (_node) => {
        app.graph.setDirtyCanvas(true, true)
      }
...
LGraphNode.prototype.connectByType = function connectByType(
  ...
  return (
    (oldLGraphNodeConnectByType &&
      oldLGraphNodeConnectByType.call(
        this,
        slot,
        sourceNode,
        sourceSlotType,
