...
export function drawLabelAndValue(
  ...
  const labelX =
    ...
    innerMargin +
    ((_a =
      options === null || options === void 0 ? void 0 : options.offsetLeft) !==
      null && _a !== void 0
      ? _a
      : 0)
  ...
  ctx.textAlign = 'right'
  ctx.fillText(
    fitString(ctx, value, valueXRight - valueXLeft),
    valueXRight,
    midY
  )
  ctx.restore()
...
export class RgthreeDividerWidget {
  ...
  draw(ctx, node, width, posY, h) {
    if (this.widgetOptions.thickness) {
      ...
      const w =
        width - this.widgetOptions.marginLeft - this.widgetOptions.marginRight
  ...
  computeSize(width) {
    return [
      width,
      this.widgetOptions.marginTop +
        this.widgetOptions.marginBottom +
        this.widgetOptions.thickness
    ]
  }
}
