      ...
      if (await clipboardSupportedPromise) {
        ...
        nodeType.prototype.getExtraMenuOptions = function (canvas, options) {
          ...
          if ((_a = this.imgs) === null || _a === void 0 ? void 0 : _a.length) {
            let img =
              this.imgs[this.imageIndex || 0] ||
              this.imgs[this.overIndex || 0] ||
              this.imgs[0]
            const foundIdx = options.findIndex((option) => {
              var _a
              return (_a =
                option === null || option === void 0
                  ? void 0
                  : option.content) === null || _a === void 0
                ? void 0
                : _a.includes('Copy Image')
            })
            if (img && foundIdx === -1) {
              const menuItem = {
