...
class RgthreePowerLoraLoader extends RgthreeBaseServerNode {
  constructor(title = NODE_CLASS.title) {
    ...
    this.properties[PROP_LABEL_SHOW_STRENGTHS] =
  ...
  configure(info) {
    ...
    for (const widgetValue of info.widgets_values || []) {
      if (
        (widgetValue === null || widgetValue === void 0
          ? void 0
          : widgetValue.lora) !== undefined
      ) {
  ...
  onNodeCreated() {
    var _b
    ;(_b = super.onNodeCreated) === null || _b === void 0
      ? void 0
      : _b.call(this)
    this.addNonLoraWidgets()
  ...
  addNewLoraWidget(lora) {
    ...
    if (this.widgetButtonSpacer) {
      moveArrayItem(
        this.widgets,
        widget,
        this.widgets.indexOf(this.widgetButtonSpacer)
      )
    }
    return widget
  }
  addNonLoraWidgets() {
    ...
    this.addCustomWidget(
      new RgthreeBetterButtonWidget('➕ Add Lora', (event, pos, node) => {
            ...
            (value) => {
              ...
              if (typeof value === 'string') {
                if (value.includes('Power Lora Chooser')) {
                  ...
                  const computed = this.computeSize()
                  const tempHeight =
                    (_b = this._tempHeight) !== null && _b !== void 0 ? _b : 15
  ...
  getSlotInPosition(canvasX, canvasY) {
    ...
    if (!slot) {
      ...
      if (
        (_b =
          lastWidget === null || lastWidget === void 0
            ? void 0
            : lastWidget.name) === null || _b === void 0
          ? void 0
          : _b.startsWith('lora_')
      ) {
  ...
  getSlotMenuOptions(slot) {
    ...
    if (
      (_c =
        (_b = slot === null || slot === void 0 ? void 0 : slot.widget) ===
          null || _b === void 0
          ? void 0
      ...
      const canMoveUp = !!((_e =
        (_d = this.widgets[index - 1]) === null || _d === void 0
          ? void 0
          : _d.name) === null || _e === void 0
        ? void 0
        : _e.startsWith('lora_'))
      const canMoveDown = !!((_g =
        (_f = this.widgets[index + 1]) === null || _f === void 0
          ? void 0
  ...
  hasLoraWidgets() {
    var _b
    return !!((_b = this.widgets) === null || _b === void 0
      ? void 0
      : _b.find((w) => {
          var _b
          return (_b = w.name) === null || _b === void 0
            ? void 0
            : _b.startsWith('lora_')
        }))
  }
  allLorasState() {
    ...
    for (const widget of this.widgets) {
      if (
        (_b = widget.name) === null || _b === void 0
          ? void 0
          : _b.startsWith('lora_')
      ) {
        const on =
          (_c = widget.value) === null || _c === void 0 ? void 0 : _c.on
        allOn = allOn && on === true
    ...
    return allOn &&
      ((_d = this.widgets) === null || _d === void 0 ? void 0 : _d.length)
      ? true
      : false
  }
  toggleAllLoras() {
...
class PowerLoraLoaderHeaderWidget extends RgthreeBaseWidget {
  ...
  draw(ctx, node, w, posY, height) {
    ...
    this.showModelAndClip =
      node.properties[PROP_LABEL_SHOW_STRENGTHS] ===
...
class PowerLoraLoaderWidget extends RgthreeBaseWidget {
  ...
  draw(ctx, node, w, posY, height) {
      ...
      if (this.showModelAndClip) {
        if (oldShowModelAndClip != null) {
          this.value.strengthTwo =
            (_b = this.value.strength) !== null && _b !== void 0 ? _b : 1
        }
      } else {
    ...
    const strengthValue = this.showModelAndClip
      ? (_c = this.value.strengthTwo) !== null && _c !== void 0
        ? _c
        : 1
      : (_d = this.value.strength) !== null && _d !== void 0
        ? _d
        : 1
    let textColor = undefined
    if (
      ((_e = this.loraInfo) === null || _e === void 0
        ? void 0
        : _e.strengthMax) != null &&
      strengthValue >
        ((_f = this.loraInfo) === null || _f === void 0
          ? void 0
          : _f.strengthMax)
    ) {
      textColor = '#c66'
    } else if (
      ((_g = this.loraInfo) === null || _g === void 0
        ? void 0
        : _g.strengthMin) != null &&
      strengthValue <
        ((_h = this.loraInfo) === null || _h === void 0
          ? void 0
          : _h.strengthMin)
    ) {
      textColor = '#c66'
    ...
    if (this.showModelAndClip) {
      ...
      let textColor = undefined
      if (
        ((_j = this.loraInfo) === null || _j === void 0
          ? void 0
          : _j.strengthMax) != null &&
        this.value.strength >
          ((_k = this.loraInfo) === null || _k === void 0
            ? void 0
            : _k.strengthMax)
      ) {
        textColor = '#c66'
      } else if (
        ((_l = this.loraInfo) === null || _l === void 0
          ? void 0
          : _l.strengthMin) != null &&
        this.value.strength <
          ((_m = this.loraInfo) === null || _m === void 0
            ? void 0
            : _m.strengthMin)
      ) {
        textColor = '#c66'
    ...
    ctx.textAlign = 'left'
    ctx.textBaseline = 'middle'
    const loraLabel = String(
      ((_p = this.value) === null || _p === void 0 ? void 0 : _p.lora) || 'None'
    )
  ...
  doOnStrengthAnyMove(event, isTwo = false) {
    ...
    if (event.deltaX) {
      ...
      this.value[prop] =
        ((_b = this.value[prop]) !== null && _b !== void 0 ? _b : 1) +
        event.deltaX * 0.05
    }
  }
