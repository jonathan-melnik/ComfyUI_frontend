...
class RgthreeInfoDialog extends RgthreeDialog {
  ...
  async init(file) {
    ...
    this.setTitle(
      ((_a = this.modelInfo) === null || _a === void 0 ? void 0 : _a['name']) ||
        ((_b = this.modelInfo) === null || _b === void 0
          ? void 0
          : _b['file']) ||
        'Unknown'
    )
  ...
  async handleEventAction(action, target, e) {
    ...
    if (action === 'fetch-civitai') {
      ...
      this.setContent(this.getInfoContent())
      this.setTitle(
        ((_a = this.modelInfo) === null || _a === void 0
          ? void 0
          : _a['name']) ||
          ((_b = this.modelInfo) === null || _b === void 0
            ? void 0
  ...
  getInfoContent() {
    ...
    const info = this.modelInfo || {}
    const civitaiLink =
      (_a = info.links) === null || _a === void 0
        ? void 0
        : _a.find((i) => i.includes('civitai.com/models'))
    const html = `
      ...
      <table class="rgthree-info-table">
        ...
        ${
          civitaiLink
            ...
            : ((_c =
                  (_b = info.raw) === null || _b === void 0
                    ? void 0
                    : _b.civitai) === null || _c === void 0
                  ? void 0
                  : _c.error) === 'Model not found'
              ? infoTableRow(
                  'Civitai',
              ...
              : (
                    (_e =
                      (_d = info.raw) === null || _d === void 0
                        ? void 0
                        : _d.civitai) === null || _e === void 0
                      ? void 0
                      : _e.error
                  )
                ? infoTableRow(
                    'Civitai',
                    (_g =
                      (_f = info.raw) === null || _f === void 0
                        ? void 0
                        : _f.civitai) === null || _g === void 0
                      ? void 0
                      : _g.error
                  )
                : !((_h = info.raw) === null || _h === void 0
                      ? void 0
                      : _h.civitai)
                  ? infoTableRow(
                      'Civitai',
        ...
        ${
          !((_l = info.trainedWords) === null || _l === void 0
            ? void 0
            : _l.length)
            ? ''
            : infoTableRow(
                'Trained Words',
                (_m = getTrainedWordsMarkup(info.trainedWords)) !== null &&
                  _m !== void 0
                  ? _m
                  : '',
        ...
        ${
          !((_p =
            (_o = info.raw) === null || _o === void 0
              ? void 0
              : _o.metadata) === null || _p === void 0
            ? void 0
            : _p.ss_clip_skip) ||
          ((_r =
            (_q = info.raw) === null || _q === void 0
              ? void 0
              : _q.metadata) === null || _r === void 0
            ? void 0
            : _r.ss_clip_skip) == 'None'
            ? ''
            : infoTableRow(
                'Clip Skip',
                (_t =
                  (_s = info.raw) === null || _s === void 0
                    ? void 0
              ...
              },
              {
                ...
                callback: async (e) => {
                  ...
                  if (
                    ...
                    this.modelInfo = await LORA_INFO_SERVICE.clearFetchedInfo(
                      this.modelInfo.file
                    )
                    this.setContent(this.getInfoContent())
                    this.setTitle(
                      ((_b = this.modelInfo) === null || _b === void 0
                        ? void 0
                        : _b['name']) ||
                        ((_c = this.modelInfo) === null || _c === void 0
                          ? void 0
                          : _c['file']) ||
                        'Unknown'
                    )
...
function imgInfoField(label, value) {
  return value != null
    ? `<span>${label ? `<label>${label} </label>` : ''}${value}</span>`
    : ''
}
