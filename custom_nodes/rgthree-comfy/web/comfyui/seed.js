...
class RgthreeSeed extends RgthreeBaseServerNode {
  ...
  async handleAction(action) {
    if (action === 'Randomize Each Time') {
      ...
      this.seedWidget.value =
        this.lastSeed != null ? this.lastSeed : this.seedWidget.value
  ...
  onNodeCreated() {
    var _a
    ;(_a = super.onNodeCreated) === null || _a === void 0
      ? void 0
      : _a.call(this)
    ...
    this.addWidget(
      ...
      () => {
        this.seedWidget.value =
          Math.floor(Math.random() * this.randomRange) * (step / 10) +
          this.randMin
      },
      { serialize: false }
    )
  ...
  handleApiHijacking(e) {
    ...
    let workflowNode =
      (_b =
        (_a =
          workflow === null || workflow === void 0
            ? void 0
            : workflow.nodes) === null || _a === void 0
          ? void 0
          : _a.find((n) => n.id === this.id)) !== null && _b !== void 0
        ? _b
        : null
    let outputInputs =
      (_c = output === null || output === void 0 ? void 0 : output[this.id]) ===
        null || _c === void 0
        ? void 0
        : _c.inputs
    if (
  ...
  getSeedToUse() {
    ...
    if (SPECIAL_SEEDS.includes(inputSeed)) {
      if (
        typeof this.lastSeed === 'number' &&
        !SPECIAL_SEEDS.includes(this.lastSeed)
      ) {
