...
export class BaseNodeModeChanger extends BaseAnyInputConnectedNode {
  ...
  handleLinkedNodesStabilization(linkedNodes) {
    ...
    for (const [index, node] of linkedNodes.entries()) {
      ...
      if (!widget) {
        ...
        widget = this.addWidget('toggle', '', false, '', {
          on: 'yes',
          off: 'no'
        })
        changed = true
  ...
  setWidget(widget, linkedNode, forceValue) {
    let changed = false
    const value =
      forceValue == null ? linkedNode.mode === this.modeOn : forceValue
    ...
    if (widget.name !== name) {
      ...
      widget.doModeChange = (forceValue, skipOtherNodeCheck) => {
        var _a, _b, _c
        let newValue =
          forceValue == null ? linkedNode.mode === this.modeOff : forceValue
          ...
          if (
            ...
            ((_b =
              (_a = this.properties) === null || _a === void 0
                ? void 0
                : _a['toggleRestriction']) === null || _b === void 0
              ? void 0
              : _b.includes(' one'))
          ) {
            ...
            ((_c = this.properties) === null || _c === void 0
              ? void 0
              : _c['toggleRestriction']) === 'always one'
          ) {
