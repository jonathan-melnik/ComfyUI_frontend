...
function showQueueNodesMenuIfOutputNodesAreSelected(existingOptions) {
  if (
    CONFIG_SERVICE.getConfigValue('features.menu_queue_selected_nodes') ===
    false
  ) {
    return
  }
  ...
  let idx =
    existingOptions.findIndex(
      (o) => (o === null || o === void 0 ? void 0 : o.content) === 'Outputs'
    ) + 1
  idx =
    idx ||
    existingOptions.findIndex(
      (o) => (o === null || o === void 0 ? void 0 : o.content) === 'Align'
    ) + 1
  idx = idx || 3
...
function showQueueGroupNodesMenuIfGroupIsSelected(existingOptions) {
  ...
  const menuItem = {
    ...
    disabled: !(outputNodes === null || outputNodes === void 0
      ? void 0
      : outputNodes.length)
  }
  let idx =
    existingOptions.findIndex((o) => {
      var _a
      return (_a = o === null || o === void 0 ? void 0 : o.content) === null ||
        _a === void 0
        ? void 0
        : _a.startsWith('Queue Selected ')
    }) + 1
  idx =
    idx ||
    existingOptions.findIndex(
