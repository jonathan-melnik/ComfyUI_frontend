...
class Rgthree extends EventTarget {
  constructor() {
    ...
    this.isMac = !!(
      ...
      ((_c =
        (_b = navigator.userAgentData) === null || _b === void 0
          ? void 0
          : _b.platform) === null || _c === void 0
        ? void 0
        : _c.toLocaleUpperCase().startsWith('MAC'))
    )
    const logLevel =
      (_d =
        LogLevelKeyToLogLevel[CONFIG_SERVICE.getConfigValue('log_level')]) !==
        null && _d !== void 0
        ? _d
        : GLOBAL_LOG_LEVEL
    ...
    CONFIG_SERVICE.addEventListener('config-change', (e) => {
      var _a, _b
      if (
        (_b = (_a = e.detail) === null || _a === void 0 ? void 0 : _a.key) ===
          null || _b === void 0
          ? void 0
          : _b.includes('features.progress_bar')
      ) {
        this.initializeProgressBar()
      }
    })
    if (CONFIG_SERVICE.getConfigValue('debug.keys_down.enabled')) {
      ...
      const updateDebugKeyDown = () => {
        elDebugKeydowns.innerText = Object.keys(
          KEY_EVENT_SERVICE.downKeys
        ).join(' ')
      }
    ...
    if (CONFIG_SERVICE.getConfigValue('features.progress_bar.enabled')) {
      ...
      if (!this.progressBarEl) {
        ...
        this.progressBarEl.addEventListener('pointerdown', async (e) => {
          ...
          if (e.button == 0) {
            const nodeId =
              (_a = this.progressBarEl) === null || _a === void 0
                ? void 0
                : _a.currentNodeId
            if (nodeId) {
      ...
      const position = CONFIG_SERVICE.getConfigValue(
        'features.progress_bar.position'
      )
      this.progressBarEl.classList.toggle(
        'rgthree-pos-bottom',
        position === 'bottom'
      )
      ...
      const height =
        CONFIG_SERVICE.getConfigValue('features.progress_bar.height') || 14
  ...
  async initializeGraphAndCanvasHooks() {
    ...
    LGraph.prototype.serialize = function () {
      ...
      rgthree.initialGraphToPromptSerializedWorkflowBecauseComfyUIBrokeStuff =
        response
      return response
    }
  ...
  async invokeExtensionsAsync(method, ...args) {
    ...
    const comfyapp = app
    if (
      CONFIG_SERVICE.getConfigValue(
        'features.invoke_extensions_async.node_created'
      ) === false
    ) {
    ...
    setTimeout(async () => {
      ...
      LGraphCanvas.prototype.getCanvasMenuOptions = function (...args) {
        ...
        options.push({
          ...
          className:
            'rgthree-contextmenu-item rgthree-contextmenu-main-item-rgthree-comfy',
          submenu: {
        ...
        idx =
          ...
          existingOptions.findIndex((o) => {
            var _a, _b
            return (_b =
              (_a = o === null || o === void 0 ? void 0 : o.content) === null ||
              _a === void 0
                ? void 0
  ...
  getRgthreeContextMenuItems() {
    ...
    const showBookmarks = CONFIG_SERVICE.getFeatureValue(
      'menu_bookmarks.enabled'
    )
  ...
  initializeComfyUIHooks() {
    ...
    api.queuePrompt = async function (index, prompt) {
      var _a
      if (
        ((_a = rgthree.queueNodeIds) === null || _a === void 0
          ? void 0
          : _a.length) &&
        prompt.output
      ) {
    ...
    app.loadGraphData = function (graph) {
      ...
      setTimeout(() => {
        var _a, _b, _c
        const wasLoadingAborted =
          (_b =
            (_a = document.querySelector('.comfy-modal-content')) === null ||
            _a === void 0
              ? void 0
              : _a.textContent) === null || _b === void 0
            ? void 0
            : _b.includes('Loading aborted due')
        ...
        if (fixBadLinksResult.hasBadLinks) {
          const [n, v] = rgthree.logParts(
            LogLevel.WARN,
            `The workflow you've loaded has corrupt linking data. Open ${new URL(location.href).origin}/rgthree/link_fixer to try to fix.`
          )
          ;(_c = console[n]) === null || _c === void 0
            ? void 0
            : _c.call(console, ...v)
          if (
            CONFIG_SERVICE.getConfigValue(
              'features.show_alerts_for_corrupt_workflows'
            )
          ) {
            rgthree.showMessage({
              id: 'bad-links',
                    ...
                    if (
                      ...
                      try {
                        ...
                        if (!fixBadLinksResult.hasBadLinks) {
                          ...
                          wasLoadingAborted &&
                            app.loadGraphData(fixBadLinksResult.graph)
                          if (
                            CONFIG_SERVICE.getConfigValue(
                              'features.monitor_for_corrupt_links'
                            ) ||
                            CONFIG_SERVICE.getConfigValue(
                              'features.monitor_bad_links'
                            )
                          ) {
  ...
  getNodeFromInitialGraphToPromptSerializedWorkflowBecauseComfyUIBrokeStuff(
    ...
    return (_c =
      (_b =
        (_a =
          this
            .initialGraphToPromptSerializedWorkflowBecauseComfyUIBrokeStuff) ===
          null || _a === void 0
          ? void 0
          : _a.nodes) === null || _b === void 0
        ? void 0
        : _b.find((n) => n.id === node.id)) !== null && _c !== void 0
      ? _c
      : null
  }
  ...
  async hideMessage(id) {
    const msg = document.querySelector(
      `.rgthree-top-messages-container > [msg-id="${id}"]`
    )
    if (
      msg === null || msg === void 0 ? void 0 : msg.classList.contains('-show')
    ) {
  ...
  isDebugMode() {
    ...
    return (
      ...
      window.location.href.includes('rgthree-debug')
    )
  }
  isDevMode() {
    ...
    return (
      GLOBAL_LOG_LEVEL >= LogLevel.DEV ||
      window.location.href.includes('rgthree-dev')
    )
  }
  monitorBadLinks() {
