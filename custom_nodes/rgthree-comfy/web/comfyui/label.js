...
export class Label extends RgthreeBaseVirtualNode {
  ...
  draw(ctx) {
    ...
    const padding =
      (_b = Number(this.properties['padding'])) !== null && _b !== void 0
        ? _b
        : 0
  ...
  onShowCustomPanelInfo(panel) {
    var _a, _b
    ;(_a = panel.querySelector('div.property[data-property="Mode"]')) ===
      null || _a === void 0
      ? void 0
      : _a.remove()
    ;(_b = panel.querySelector('div.property[data-property="Color"]')) ===
      null || _b === void 0
      ? void 0
      : _b.remove()
  }
...
LGraph.prototype.getNodeOnPos = function (x, y, nodes_list, margin) {
  ...
  if (
    ...
    ((_a = rgthree.lastAdjustedMouseEvent) === null || _a === void 0
      ? void 0
      : _a.type.includes('down')) &&
    ((_b = rgthree.lastAdjustedMouseEvent) === null || _b === void 0
      ? void 0
      : _b.which) === 1
  ) {
    let isDoubleClick =
