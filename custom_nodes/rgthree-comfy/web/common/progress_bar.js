...
export class RgthreeProgressBar extends HTMLElement {
  ...
  get currentNodeId() {
    ...
    const nodeId =
      ((_a =
        prompt === null || prompt === void 0 ? void 0 : prompt.errorDetails) ===
        null || _a === void 0
        ? void 0
        : _a.node_id) ||
      ((_b =
        prompt === null || prompt === void 0
          ? void 0
          : prompt.currentlyExecuting) === null || _b === void 0
        ? void 0
        : _b.nodeId)
    return nodeId || null
  }
  ...
  onProgressUpdate(e) {
    ...
    if (
      prompt === null || prompt === void 0 ? void 0 : prompt.currentlyExecuting
    ) {
      ...
      if (!prompt.totalNodes) {
        ...
        const percent =
          (prompt.executedNodeIds.length / prompt.totalNodes) * 100
        this.progressNodesEl.style.width = `${Math.max(2, percent)}%`
        progressText += `${Math.round(percent)}%`
      }
      let nodeLabel =
        (_d = current.nodeLabel) === null || _d === void 0 ? void 0 : _d.trim()
      let stepsLabel = ''
  ...
  connectedCallback() {
    ...
    const overlayEl = createElement(`div.overlay[part="overlay"]`, {
      parent: this.shadow
    })
    this.progressNodesEl = createElement(`div.bar[part="progress-nodes"]`, {
      parent: this.shadow
    })
    this.progressStepsEl = createElement(`div.bar[part="progress-steps"]`, {
      parent: this.shadow
    })
    this.progressTextEl = createElement(`span[part="text"]`, {
      text: 'Idle',
      parent: this.shadow
    })
  }
