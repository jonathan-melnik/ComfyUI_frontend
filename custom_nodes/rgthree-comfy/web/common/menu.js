    ...
    this.element.addEventListener('pointerup', async (e) => {
      ...
      const callback =
        (_a =
          ...
          : _a['callback']
      if (callback) {
        const halt = await ((_b = this.callbacks.get(callback)) === null ||
        _b === void 0
          ? void 0
          : _b(e))
        if (halt !== false) {
  ...
  setOptions(options) {
    for (const option of options) {
      if (option.type === 'title') {
        ...
        this.callbacks.set(id, async (e) => {
          var _a
          return (_a =
            option === null || option === void 0 ? void 0 : option.callback) ===
            null || _a === void 0
            ? void 0
            : _a.call(option, e)
        })
        this.element.appendChild(
          $el(`li[role="button"][data-callback="${id}"]`, {
            html: option.label
          })
        )
      }
