...
export async function tryToGetWorkflowDataFromEvent(e) {
  var _a, _b, _c, _d
  let work
  for (const file of ((_a = e.dataTransfer) === null || _a === void 0
    ? void 0
    : _a.files) || []) {
  ...
  const match = (
    ((_b = e.dataTransfer) === null || _b === void 0 ? void 0 : _b.types) || []
  ).find((t) => validTypes.find((v) => t === v))
  if (match) {
    const uri =
      (_d =
        (_c = e.dataTransfer.getData(match)) === null || _c === void 0
          ? void 0
          : _c.split('\n')) === null || _d === void 0
        ? void 0
        : _d[0]
...
export async function tryToGetWorkflowDataFromFile(file) {
  ...
  if (file.type === 'image/png') {
    ...
    return {
      workflow: parseWorkflowJson(
        pngInfo === null || pngInfo === void 0 ? void 0 : pngInfo.workflow
      ),
      prompt: parseWorkflowJson(
        pngInfo === null || pngInfo === void 0 ? void 0 : pngInfo.prompt
      )
    }
  }
  if (file.type === 'image/webp') {
    ...
    const prompt = parseWorkflowJson(
      (pngInfo === null || pngInfo === void 0 ? void 0 : pngInfo.prompt) ||
        (pngInfo === null || pngInfo === void 0 ? void 0 : pngInfo.Prompt) ||
        'null'
    )
  ...
  if (
    ...
    ((_a = file.name) === null || _a === void 0 ? void 0 : _a.endsWith('.json'))
  ) {
    ...
    reader.onload = async () => {
      ...
      const workflow =
        !isApiJson &&
        !(json === null || json === void 0 ? void 0 : json.templates)
          ? json
          : null
      return { workflow, prompt }
    }
