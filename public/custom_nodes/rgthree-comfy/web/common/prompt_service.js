...
export class PromptExecution {
  ...
  getApiNode(nodeId) {
    var _a
    return (
      ((_a = this.promptApi) === null || _a === void 0
        ? void 0
        : _a[String(nodeId)]) || null
    )
  }
  getNodeLabel(nodeId) {
    var _a, _b
    ...
    let label =
      ((_a =
        apiNode === null || apiNode === void 0 ? void 0 : apiNode._meta) ===
        null || _a === void 0
        ? void 0
        : _a.title) ||
  ...
  executing(nodeId, step, maxSteps) {
    ...
    if (
      ((_a = this.currentlyExecuting) === null || _a === void 0
        ? void 0
        : _a.nodeId) !== nodeId
    ) {
      ...
      this.currentlyExecuting = {
        nodeId,
        nodeLabel: this.getNodeLabel(nodeId),
        pass: 0
      }
      this.apiPrompt.promise.then(() => {
        ...
        if (
          (apiNode === null || apiNode === void 0
            ? void 0
            : apiNode.class_type) === 'UltimateSDUpscale'
        ) {
          ...
          (apiNode === null || apiNode === void 0
            ? void 0
            : apiNode.class_type) === 'IterativeImageUpscale'
        ) {
          this.currentlyExecuting.maxPasses =
            (_a =
              apiNode === null || apiNode === void 0
                ? void 0
                : apiNode.inputs['steps']) !== null && _a !== void 0
              ? _a
              : -1
        }
      })
    ...
    if (step != null) {
      if (
        ...
        step < this.currentlyExecuting.step
      ) {
        this.currentlyExecuting.pass++
      }
  ...
  maybeGetComfyGraph() {
    var _a
    return (
      ((_a = window === null || window === void 0 ? void 0 : window.app) ===
        null || _a === void 0
        ? void 0
        : _a.graph) || null
    )
...
class PromptService extends EventTarget {
  constructor(api) {
    ...
    api.addEventListener('progress', (e) => {
      ...
      this.currentExecution.executing(
        e.detail.node,
        e.detail.value,
        e.detail.max
      )
    ...
    api.addEventListener('execution_error', (e) => {
      ...
      ;(_a = this.currentExecution) === null || _a === void 0
        ? void 0
        : _a.error(e.detail)
      this.dispatchProgressUpdate()
    })
