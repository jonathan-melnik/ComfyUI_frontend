...
const CONFIG_REROUTE =
  ((_a =
    rgthreeConfig === null || rgthreeConfig === void 0
      ? void 0
      : rgthreeConfig['nodes']) === null || _a === void 0
    ? void 0
    : _a['reroute']) || {}
const CONFIG_FAST_REROUTE = CONFIG_REROUTE['fast_reroute']
const CONFIG_FAST_REROUTE_ENABLED =
  (_b = CONFIG_FAST_REROUTE['enabled']) !== null && _b !== void 0 ? _b : false
const CONFIG_KEY_CREATE_WHILE_LINKING =
  CONFIG_FAST_REROUTE['key_create_while_dragging_link']
...
if (
  !LAYOUT_LABEL_TO_DATA[configLayout[1]] ||
  configLayout[0] == configLayout[1]
) {
...
class RerouteService {
  constructor() {
    ...
    if (
      ...
      (CONFIG_KEY_CREATE_WHILE_LINKING === null ||
      CONFIG_KEY_CREATE_WHILE_LINKING === void 0
        ? void 0
        : CONFIG_KEY_CREATE_WHILE_LINKING.trim())
    ) {
  ...
  async onCanvasSetUpListenerForLinking() {
    ...
    Object.defineProperty(canvas, canvasProperty, {
      ...
      set: function (value) {
        ...
        const isPropNull =
          !this[`_${canvasProperty}`] ||
          !((_a = this[`_${canvasProperty}`]) === null || _a === void 0
            ? void 0
            : _a.length)
  ...
  startingLinking() {
    ...
    KEY_EVENT_SERVICE.addEventListener(
      'keydown',
      this.handleLinkingKeydownBound
    )
  ...
  getConnectingData() {
    ...
    if (
      ...
      ((_a = oldCanvas.connecting_pos) === null || _a === void 0
        ? void 0
        : _a.length)
    ) {
      return {
    ...
    if (
      (_b = canvas.connecting_links) === null || _b === void 0
        ? void 0
        : _b.length
    ) {
  ...
  insertNewRerouteWhileLinking() {
    ...
    let connectingDir =
      (_a = data.input || data.output) === null || _a === void 0
        ? void 0
        : _a.dir
    if (!connectingDir) {
  ...
  handleMoveOrResizeNodeMaybeWhileDragging(node) {
    ...
    if (
      this.isFastLinking &&
      node === (data === null || data === void 0 ? void 0 : data.node)
    ) {
      const entry =
        this.fastReroutesHistory[this.fastReroutesHistory.length - 1]
      if (entry) {
  ...
  handleRemovedNodeMaybeWhileDragging(node) {
    const currentEntry =
      this.fastReroutesHistory[this.fastReroutesHistory.length - 1]
    if (
      (currentEntry === null || currentEntry === void 0
        ? void 0
...
class RerouteNode extends RgthreeBaseVirtualNode {
  ...
  onConstructed() {
    var _a
    this.setResizable(
      (_a = this.properties['resizable']) !== null && _a !== void 0
        ? _a
        : configResizable
    )
  ...
  configure(info) {
    ...
    this.setResizable(
      (_c = this.properties['resizable']) !== null && _c !== void 0
        ? _c
        : configResizable
    )
    this.applyNodeSize()
  ...
  onDrawForeground(ctx, canvas) {
    var _a, _b, _c, _d
    if (
      (_a = this.properties) === null || _a === void 0
        ? void 0
        : _a['showLabel']
    ) {
      const low_quality =
        ((_b = canvas === null || canvas === void 0 ? void 0 : canvas.ds) ===
          null || _b === void 0
          ? void 0
          : _b.scale) && canvas.ds.scale < 0.6
      ...
      ctx.fillText(
        String(
          this.title && this.title !== RerouteNode.title
            ? this.title
            : ((_d =
                (_c = this.outputs) === null || _c === void 0
                  ? void 0
                  : _c[0]) === null || _d === void 0
                ? void 0
                : _d.type) || ''
  ...
  disconnectInput(slot) {
    var _a
    if (
      rgthree.replacingReroute != null &&
      ((_a = this.inputs[0]) === null || _a === void 0 ? void 0 : _a.link)
    ) {
      const graph = app.graph
      const link = graph.links[this.inputs[0].link]
      const node = graph.getNodeById(
        link === null || link === void 0 ? void 0 : link.origin_id
      )
      if (
  ...
  stabilize() {
    ...
    while (currentNode) {
      ...
      if (linkId !== null) {
        ...
        if (
          type === null || type === void 0 ? void 0 : type.includes('Reroute')
        ) {
          if (node === this) {
          ...
          input =
            (_a = node.outputs[inputNodeOutputSlot]) !== null && _a !== void 0
              ? _a
              : null
          inputType =
            (_b = input === null || input === void 0 ? void 0 : input.type) !==
              null && _b !== void 0
              ? _b
              : null
          break
      ...
      if (outputs.length) {
        for (const linkId of outputs) {
          ...
          if (
            ...
            const output =
              (_d =
                (_c = node.inputs) === null || _c === void 0
                  ? void 0
                  : _c[link.target_slot]) !== null && _d !== void 0
                ? _d
                : null
            const nodeOutType =
              output === null || output === void 0 ? void 0 : output.type
            if (nodeOutType == null) {
              console.warn(
              ...
              console.warn(
                `[rgthree] Reroute - Disconnecting connected node's input (${node.id}.${link.target_slot}) (${node.type}) because its type (${String(nodeOutType)}) does not match the reroute type (${String(inputType)})`
              )
              node.disconnectInput(link.target_slot)
            } else {
              ...
              outputWidget = null
              if (
                output === null || output === void 0 ? void 0 : output.widget
              ) {
                try {
                  const config = getWidgetConfig(output)
                  if (!outputWidgetConfig && config) {
                    outputWidgetConfig =
                      (_e = config[1]) !== null && _e !== void 0 ? _e : {}
                    outputType = config[0]
                    if (!outputWidget) {
                      outputWidget =
                        (_f = outputNode.widgets) === null || _f === void 0
                          ? void 0
                          : _f.find((w) => {
                              var _a
                              return (
                                ...
                                ((_a =
                                  output === null || output === void 0
                                    ? void 0
                                    : output.widget) === null || _a === void 0
                                  ? void 0
                                  : _a.name)
                              )
                            })
                    }
                    const merged = mergeIfValid(output, [
                      config[0],
                      outputWidgetConfig
                    ])
    ...
    for (const node of updateNodes) {
      ...
      node.outputs[0].name =
        (input === null || input === void 0 ? void 0 : input.name) || ''
      node.size = node.computeSize()
      ;(_h = (_g = node).applyNodeSize) === null || _h === void 0
        ? void 0
        : _h.call(_g)
      ...
      try {
        if (outputWidgetConfig && outputWidget && outputType) {
          ...
          setWidgetConfig(
            node.inputs[0],
            [
              outputType !== null && outputType !== void 0
                ? outputType
                : displayType,
              outputWidgetConfig
            ],
        ...
        console.error(
          '[rgthree] Could not set widget config for reroute; maybe ComfyUI updated?'
        )
        outputWidgetConfig = null
        outputWidget = null
        if (
          (_j = node.inputs[0]) === null || _j === void 0 ? void 0 : _j.widget
        ) {
    ...
    ;(_k =
      inputNode === null || inputNode === void 0
        ? void 0
        : inputNode.onConnectionsChainChange) === null || _k === void 0
      ? void 0
      : _k.call(inputNode)
    ;(_l =
      outputNode === null || outputNode === void 0
        ? void 0
        : outputNode.onConnectionsChainChange) === null || _l === void 0
      ? void 0
      : _l.call(outputNode)
    app.graph.setDirtyCanvas(true, true)
  }
  ...
  stabilizeLayout(oldSize, newSize) {
    if (newSize[0] === 10 || newSize[1] === 10) {
      ...
      props['connections_layout'] = props['connections_layout'] || [
        'Left',
        'Right'
      ]
  ...
  manuallyHandleMove(event) {
    ...
    if (shortcut.state) {
      const diffX =
        Math.round((event.clientX - shortcut.initialMousePos[0]) / 10) * 10
      const diffY =
        Math.round((event.clientY - shortcut.initialMousePos[1]) / 10) * 10
  ...
  cycleConnection(ioDir) {
    ...
    if (this.size[0] === 10 || this.size[1] === 10) {
      ...
      let next =
        (_a = options[idx + 1]) !== null && _a !== void 0 ? _a : options[0]
    ...
    do {
      ...
      next =
        (_b = LAYOUT_CLOCKWISE[idx + 1]) !== null && _b !== void 0
          ? _b
          : LAYOUT_CLOCKWISE[0]
  ...
  onMouseMove(event) {
    if (this.shortcuts.move.state) {
      ...
      if (shortcut.initialMousePos[0] === -1) {
        ...
        shortcut.resizeOnSide[0] =
          this.pos[0] > offset[0] ? LiteGraph.LEFT : LiteGraph.RIGHT
        shortcut.resizeOnSide[1] =
          this.pos[1] > offset[1] ? LiteGraph.UP : LiteGraph.DOWN
      }
  ...
  onDeselected() {
    var _a
    ;(_a = super.onDeselected) === null || _a === void 0
      ? void 0
      : _a.call(this)
    const canvas = app.canvas
    for (const [key, shortcut] of Object.entries(this.shortcuts)) {
...
addMenuItem(RerouteNode, app, {
  name: (node) => {
    var _a
    return `${((_a = node.properties) === null || _a === void 0 ? void 0 : _a['showLabel']) ? 'Hide' : 'Show'} Label/Title`
  },
  property: 'showLabel',
  ...
  callback: (node_, value) => {
    ...
    if (
      value === null || value === void 0
        ? void 0
        : value.startsWith('Rotate 90° Clockwise')
    ) {
      node.rotate(90)
    } else if (
      value === null || value === void 0
        ? void 0
        : value.startsWith('Rotate 90° Counter-Clockwise')
    ) {
      node.rotate(-90)
    } else if (
      value === null || value === void 0
        ? void 0
        : value.startsWith('Rotate 180°')
    ) {
      node.rotate(180)
    } else {
      const inputDirIndex = LAYOUT_CLOCKWISE.indexOf(
      ...
      if (
        value === null || value === void 0
          ? void 0
          : value.startsWith('Flip Horizontally')
      ) {
        if (
        ...
        value === null || value === void 0
          ? void 0
          : value.startsWith('Flip Vertically')
      ) {
        if (
        ...
        if (
          ['Top', 'Bottom'].includes(node.properties['connections_layout'][1])
        ) {
          node.properties['connections_layout'][1] =
            LAYOUT_CLOCKWISE[(((outputDirIndex + 2) % 4) + 4) % 4]
        }
