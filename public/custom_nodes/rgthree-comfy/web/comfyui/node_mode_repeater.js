...
class NodeModeRepeater extends BaseCollectorNode {
  ...
  onConnectOutput(outputIndex, inputType, inputSlot, inputNode, inputIndex) {
    ...
    let nextNode =
      getConnectedOutputNodesAndFilterPassThroughs(this, inputNode)[0] ||
      inputNode
    return (
      canConnect &&
      [
  ...
  onConnectInput(inputIndex, outputType, outputSlot, outputNode, outputIndex) {
    var _a
    let canConnect =
      (_a = super.onConnectInput) === null || _a === void 0
        ? void 0
        : _a.call(
            this,
            inputIndex,
    ...
    let nextNode =
      getConnectedOutputNodesAndFilterPassThroughs(this, outputNode)[0] ||
      outputNode
    ...
    for (const [index, inputNode] of inputNodes.entries()) {
      if (
        (inputNode === null || inputNode === void 0
          ? void 0
          : inputNode.type) === NodeTypesString.NODE_MODE_RELAY
      ) {
        if (hasTogglerOutput) {
          console.log(
  ...
  onModeChange(from, to) {
    ...
    const linkedNodes = getConnectedInputNodesAndFilterPassThroughs(
      this
    ...
    if (linkedNodes.length) {
      ...
      (_a = app.graph._groups) === null || _a === void 0 ? void 0 : _a.length
    ) {
      for (const group of app.graph._groups) {
        group.recomputeInsideNodes()
        if (
          (_b = group._nodes) === null || _b === void 0
            ? void 0
            : _b.includes(this)
        ) {
