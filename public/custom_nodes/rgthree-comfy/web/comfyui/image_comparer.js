...
export class RgthreeImageComparer extends RgthreeBaseServerNode {
  ...
  onExecuted(output) {
    var _a
    ;(_a = super.onExecuted) === null || _a === void 0
      ? void 0
      : _a.call(this, output)
    if ('images' in output) {
  ...
  onSerialize(o) {
    ...
    for (let [index, widget_value] of (o.widgets_values || []).entries()) {
      if (
        ((_a = this.widgets[index]) === null || _a === void 0
          ? void 0
          : _a.name) === 'rgthree_comparer'
      ) {
  ...
  onMouseDown(event, pos, graphCanvas) {
    var _a
    ;(_a = super.onMouseDown) === null || _a === void 0
      ? void 0
      : _a.call(this, event, pos, graphCanvas)
    this.setIsPointerDown(true)
  }
  onMouseEnter(event, pos, graphCanvas) {
    var _a
    ;(_a = super.onMouseEnter) === null || _a === void 0
      ? void 0
      : _a.call(this, event, pos, graphCanvas)
  ...
  onMouseLeave(event, pos, graphCanvas) {
    var _a
    ;(_a = super.onMouseLeave) === null || _a === void 0
      ? void 0
      : _a.call(this, event, pos, graphCanvas)
  ...
  onMouseMove(event, pos, graphCanvas) {
    var _a
    ;(_a = super.onMouseMove) === null || _a === void 0
      ? void 0
      : _a.call(this, event, pos, graphCanvas)
  ...
  static setUp(comfyClass, nodeData) {
    RgthreeBaseServerNode.registerForOverride(
      comfyClass,
      nodeData,
...
class RgthreeImageComparerWidget extends RgthreeBaseWidget {
  ...
  onSelectionDown(event, pos, node, bounds) {
    ...
    if (
      bounds === null || bounds === void 0
        ? void 0
        : bounds.data.name.startsWith('A')
    ) {
      selected[0] = bounds.data
    } else if (
      bounds === null || bounds === void 0
        ? void 0
        : bounds.data.name.startsWith('B')
    ) {
  ...
  drawImage(ctx, image, y, cropX) {
    var _a, _b
    if (
      !((_a = image === null || image === void 0 ? void 0 : image.img) ===
        null || _a === void 0
        ? void 0
        : _a.naturalWidth) ||
      !((_b = image === null || image === void 0 ? void 0 : image.img) ===
        null || _b === void 0
        ? void 0
        : _b.naturalHeight)
    ) {
    ...
    const imageAspect =
      (image === null || image === void 0 ? void 0 : image.img.naturalWidth) /
      (image === null || image === void 0 ? void 0 : image.img.naturalHeight)
    ...
    ctx.drawImage(
      image === null || image === void 0 ? void 0 : image.img,
      sourceX,
      sourceY,
      sourceWidth,
      sourceHeight,
