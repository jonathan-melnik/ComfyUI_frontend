...
class NodeModeRelay extends BaseCollectorNode {
  ...
  onModeChange(from, to) {
    ...
    if (
      ...
      const [n, v] = logger.infoParts(
        `Mode change without any inputs; relaying our mode.`
      )
  ...
  onDrawForeground(ctx, canvas) {
    ...
    if (
      ...
      ctx.fillText(
        fitString(ctx, label, this.size[0] - 20),
        15,
        this.size[1] - 6
      )
      ctx.font = oldFont
  ...
  onConnectOutput(outputIndex, inputType, inputSlot, inputNode, inputIndex) {
    var _a, _b
    let canConnect =
      (_a = super.onConnectOutput) === null || _a === void 0
        ? void 0
        : _a.call(
            this,
            outputIndex,
    ...
    let nextNode =
      (_b = getConnectedOutputNodesAndFilterPassThroughs(
        this,
        inputNode
      )[0]) !== null && _b !== void 0
        ? _b
